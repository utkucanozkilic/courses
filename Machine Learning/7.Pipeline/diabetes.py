...
cat_cols, num_cols, cat_but = grab_col_names(df, cat_th = 5, car_th = 20)
...
# Sütun isimlerini tekrar atıyoruz:
cat_cols, num_cols, cat_but_car = grab_col_names(df, cat_th = 5, car_th = 20)

# Hedef etiketi siliyoruz
...
# Aykırı değer gözlem ve düzeltmesi:
for col in num_cols:
...
df[num_cols] = X_scaled.fit_transform(df[num_cols])
...
def base_models(X, y, scoring = "roc_auc"):
    ...
    classifiers = [('LR', LogisticRegression()),
                   ...
                   # ('CatBoost', CatBoostClassifier(verbose=False)) > Eğitim çok uzun sürüyor
                   ]
...
# 5. Stacking & Ensemble Learning (Voting Classifier)
